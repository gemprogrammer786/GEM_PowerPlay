...
public class MecanumTraction extends TractionBase {
    ...
    public void initialize(LinearOpMode linearOpMode) {
        ...
        imu_0 = hardware_map.get(BNO055IMU.class, "imu");
        imu_1 = hardware_map.get(BNO055IMU.class, "imu");

        // find the motors
        motor_rf = hardware_map.get(DcMotor.class, "frontRight");
        motor_rr = hardware_map.get(DcMotor.class, "backRight");
        motor_lf = hardware_map.get(DcMotor.class, "frontLeft");
        motor_lr = hardware_map.get(DcMotor.class, "backLeft");
