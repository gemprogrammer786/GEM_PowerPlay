...
public class AutoMode extends LinearOpMode {
    ...
    OpenCVDetector detector = new OpenCVDetector(width);
    ...
    public void runOpMode() {
        ...
        OpenCVDetector.SkystoneLocation location = detector.getLocation();
        if (location != OpenCVDetector.SkystoneLocation.NONE) {
