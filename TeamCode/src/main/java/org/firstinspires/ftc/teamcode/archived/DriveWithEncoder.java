...
public class DriveWithEncoder extends LinearOpMode
{
    ...
    public void runOpMode() throws InterruptedException
    {
        ...
        while (opModeIsActive() && leftMotor.isBusy()  && ( - leftMotor.getTargetPosition() < leftMotor.getCurrentPosition()))
        {
            telemetry.addData("Current", leftMotor.getCurrentPosition() + "  busy=" + leftMotor.isBusy());
            telemetry.addData("Target", leftMotor.getTargetPosition() + "  busy=" + leftMotor.isBusy());
            telemetry.update();
            idle();
        }
